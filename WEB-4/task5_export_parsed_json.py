...
# operate relative to script directory so it works from anywhere
LOG_PATH = Path(__file__).parent / "sample_logs.txt"
OUT_PATH = Path(__file__).parent / "parsed_logs.json"
